<%-- 
    Document   : index
    Created on : 2 Oct, 2018, 10:46:40 AM
    Author     : Nagamani
--%>
...
<body link="white">
<form name="f"  method="post" action="login1">
				...
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username is required">
						...
						SUBMIT
                                                                                ...
                                                                                <div class="container-login100-form-btn">
						<div class="wraps-login100-form-btn">
					

                                                                        		<div class="login100-form-bgbtn"></div>
                                                                                                                   
							<button class="logins100-form-btn" type="reset">
					                                                         
                                                            <a href="index-4.html" style="font-size:15px; color:white">CANCEL</a>
		</button>
					</div></div>	
                                        <br/><br>
                                        <a href="email.jsp"><font color="dodgerblue" size=4>Change Grid?</font></a>
				</form>
			</div>
		</div>
	</div>
